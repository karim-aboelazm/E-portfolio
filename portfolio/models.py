...
class AboutMe(models.Model):
    ...
    description_ar = models.TextField(max_length=100, verbose_name=_(' description_ar'))
    image          = models.ImageField(max_length=100, verbose_name=_('image'))
    job            = models.CharField(max_length=100, verbose_name=_(' job'))
    job_ar         = models.CharField(max_length=100, verbose_name=_(' job_ar'))
    ...
    address_ar       = models.CharField(max_length=100, verbose_name=_(' address_ar'),blank=True)
...
class Portfolio(models.Model):
    project_name =  models.CharField(max_length=50, verbose_name= _(' project_name') )
    project_name_ar =  models.CharField(max_length=50, verbose_name= _('project_name_ar ') )
    ...
    project_date = models.DateField(max_length=50, verbose_name= _(' project_date') )
    project_url= models.CharField(max_length=50, verbose_name= _(' project_url') )
    project_image = models.ImageField(max_length=50, verbose_name= _(' project_image') )
    project_desc= models.CharField(max_length=50, verbose_name= _(' project_desc') )
    project_desc_ar = models.CharField(max_length=50, verbose_name= _(' project_desc_ar') )
